...
public class SendMailUtil {
    ...
    static String HOST = "smtp.exmail.qq.com"; // smtp服务器
    static String FROM = "diting@leqee.com"; // 发件人地址
    static String USER = "diting@leqee.com"; // 用户名
    static String PWD = "Wang940509"; // 163的授权码
    static String SUBJECT = "谛听登录验证码"; // 邮件标题
    static String[] TOS = new String[]{"zhangchi1551@163.com", "351163675@qq.com"};
